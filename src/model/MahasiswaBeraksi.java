...
public class MahasiswaBeraksi {
    public static void main(String[] args) throws ParseException{
        ...
        mahasiswa.npm = "19710089";
        mahasiswa.nama = "Riski Nurliana";
        mahasiswa.tanggalLahir = simpleDateFormat.parse( "28-03-2001");
        ...
        mahasiswa3.npm = "19710014";
        mahasiswa3.nama = "Syintia";
